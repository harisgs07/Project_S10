...
<header>
		...
		<div class = 'adj-main-header'>
			<div class="logo" id='kl'> <a href="index.php" ><img src="assets/images/logo.png" alt="image"/></a> 
			</div>
			...
			if (strlen($_SESSION['login'])!=0)
			{
				...
				<button name='btn' class='sbtn' onclick = 'val();'> signout
				  ...
				  else
				  {
					  ...
					  <button class='sbtn' id='l' data-target="#myModal" data-toggle="modal" data-dismiss="modal">Login
						</button>
						<button class='sbtn' id='s' data-target="#myModal2" data-toggle="modal" data-dismiss="modal">Register
							</button>
							</div>
					<?php	
				  }
		...
		<!-- nav bar -->
			  ...
			  <div class="topnav" id="myTopnav">
				<nav class='nav'>
				 ...
				 {
					?>
				 <a href='#myModal' data-toggle='modal'>Store/Share File</a>
				 <?php
				 }
				 else
				 {
					...
					<div class="dropdown-content">
					  ...
					  if ($r > 0 )
						...
						{ 
							...
							{
								?>
								<a href='#myModal' data-toggle='modal'>Looking for Team<a/>
							<?php
							}
						}
						...
						{
							?>
							<a href='#myModal' data-toggle='modal'>Joining Offer <?php echo htmlentities($r1);?> </a>
						<?php
						}
						?>
					</div>
