  ...
  <div class="content-wrapper">
	...
	<!-- DIRECT CHAT -->
      ...
      <div class="container-fluid">
		...
		<div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="#" class="small-box-footer btn" onclick='view_project()'>More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
        ...
        <div class="row">
          <!-- Left col -->
   <div id='view_project' class="col-sm-12" >
...
{
$('#view_project').load('view_project.php');
