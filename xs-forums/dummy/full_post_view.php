...
<head>
  ...
  <title>XS_FORUM | POST-VIEW</title>
...
include('database.php');
				$sql2 ="SELECT p.*,a.regid, a.username from tbl_post p, tbl_account a where p.regid = a.regid and p.postid=$pstid";
...
?>
	...
	<?php
					...
					include('database.php');
					//echo "<script>alert('".$prjctid."')</script>";
					$sql2 ="SELECT p.*,a.regid, a.username from tbl_post_ans p, tbl_account a where p.regid = a.regid and p.postid=$pstid";
					$query2=mysqli_query($con,$sql2);
              ...
              <form action="#" method="post">
				  ...
				  <div class="col-md-10">
                    <textarea class="form-control form-control-sm" id="<?php echo $pstid;?>" placeholder="type here to post comment"></textarea>
					</div>
					<div class="col-md-2"  >
					<button class="btn btn-success" onclick='post_answer(this.value);' value="<?php echo $pstid; ?>" placeholder="post" style="height:35px;width:100px;margin-top:8px;"><p style="padd-left:20px;"><?php echo $pstid; ?></p>
					</button>
					</div>
