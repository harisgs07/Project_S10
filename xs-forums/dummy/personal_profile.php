...
if(isset($_REQUEST['x']))
{
	...
	include('database.php');
				$sql ="SELECT * from tbl_account where regid=$uid";
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center"><?php echo $r['role'];?></p>
                ...
                <button class="btn btn-primary btn-block" disabled><b>Follow</b></button>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
                  ...
                  <div class="tab-pane" id="settings">
                    <form  method="post" class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="Name" name="name" value=<?php echo $r['name'];?>>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                         <input type="text" class="form-control" id="inputName2" placeholder="Name" value=<?php echo $r['username'];?>>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Phone</label>
                        <div class="col-sm-10">
                         <input type="text" class="form-control" id="inputName3" placeholder="Name" value=<?php echo $r['phone'];?>>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button  onclick='update_profile(<?php echo $uid;?>);' class="btn btn-success">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
