...
if(isset($_POST['updates']))
{
	...
	if ($row>0)
		{
			$sql1="update admin_details set password='$password' where email='$email'";
    ...
    <form  method="post" name ='updateform' onSubmit="return valid();">
		...
		<hr>
         <div class="form-group">
				<input type="email" style="margin-top:13px;" class="form-control col-md-10" id='emailidupdate' name="email" onBlur="checkemail()" placeholder="Email Address" required="required">
				<span id="user-status" style="font-size:12px;"></span> 
        </div>
		<div class="form-group">
				<input type="text" style="margin-top:13px;"class="form-control col-md-10" name="password" id='passwordidupdate' placeholder="New Password"  onBlur="validpassword()"  required="required">	
				<span id="user-pass-status" style="font-size:12px;"></span>
        </div>
		<div class="form-group">

				<input type="text" style="margin-top:13px;" class="form-control col-md-10" name="confirm_password" placeholder="Confirm Password" required="required">
